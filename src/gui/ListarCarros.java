...
public class ListarCarros extends javax.swing.JFrame {
    ...
    public ListarCarros() {
        initComponents();
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Placa","Modelo","Empresa"}, 0);
        for (Carro carro : Fachada.getInstance().listarCarros()) {
            modelo.addRow(new String[]{carro.getPlaca(), carro.getModelo(), carro.getEmpresa(), ""});
        }
