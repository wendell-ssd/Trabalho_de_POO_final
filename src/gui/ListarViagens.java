...
public class ListarViagens extends javax.swing.JFrame {
    ...
    public ListarViagens() {
        initComponents();
        DefaultTableModel modelo = new DefaultTableModel(new String[] { "ID", "Origem", "Destino", "Datas" }, 0);
        for (Viagem viagem : Fachada.getInstance().listaViagens()) {
            modelo.addRow(
                    new String[] { "" + viagem.getID(), viagem.getOrigem().toString(), viagem.getDestino().toString(),
                            viagem.getDataPartida().toString() + "-" + viagem.getDataChegada().toString() });
        }
    ...
    // java.util.logging.Logger.getLogger(ListarViagens.class.getName()).log(java.util.logging.Level.SEVERE,
    // null, ex);
