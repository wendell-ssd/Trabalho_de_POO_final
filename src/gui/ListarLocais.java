 ...
 * @author Wendell
 */
public class ListarLocais extends javax.swing.JFrame {

    /**
     * Creates new form ListarLocais
     */
    public ListarLocais() {
        initComponents();
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Cidade","Estado",}, 0);
        for (Local local : Fachada.getInstance().listarLocais()) {
            modelo.addRow(new String[]{local.getCidade(),local.getEstado()});
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Locais Cadastrados");
...
//            java.util.logging.Logger.getLogger(ListarLocais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
