 ...
 * @author Wendell
 */
public class ListarHoteis extends javax.swing.JFrame {

    /**
     * Creates new form ListarHoteis
     */
    public ListarHoteis() {
        initComponents();
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Cep","Hotel","Estrelas"}, 0);
        for (Hotel hotel : Fachada.getInstance().listarHoteis()) {
            modelo.addRow(new String[]{hotel.getCep(),hotel.getNome(),""+hotel.getEstrelas(),""});
        }
        
        tabelaHoteis.setModel(modelo);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hoteis Cadastrados");
        ...
        jScrollPane1.setViewportView(tabelaHoteis);
...
//            java.util.logging.Logger.getLogger(ListarHoteis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ListarHoteis().setVisible(true);
//            }
//        });
//    }
